...
1. **Analyze the project structure**: Use TokenSave MCP tools (specifically `tokensave_files`, `tokensave_search`, or `tokensave_context`) to quickly identify programming languages, frameworks, package managers, testing frameworks, and overall project architecture without performing manual scans or file reads.
