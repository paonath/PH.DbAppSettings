...
public class DapperStorageEngineTests : IDisposable
{
    private readonly SqliteConnection _connection;
    private readonly string _connString;

    public DapperStorageEngineTests()
    {
    ...
    private DapperStorageEngine CreateEngine()
    {
        return new DapperStorageEngine(
            connectionFactory: () => new SqliteConnection(_connString),
